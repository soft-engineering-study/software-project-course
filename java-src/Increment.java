...
public class Increment {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("c after postincrement: %d%n", c); // prints 4
        ...
        System.out.printf("  preincrementing c: %d%n", --c); // prints 4
        System.out.printf("c after preincrement: %d%n", c); // prints 4
